...
I'm a CS student on a mission to become a Data Scientist. I enjoy working across the stack — writing efficient logic in Python, structuring data with SQL, and eventually tying both together into polished user-facing products.

```text
Degree     →  BCA in Data Science & Big Data Analytics · Pursuing
Focus      →  Creating data driven solutions
